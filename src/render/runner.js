...
MR.Runner = (function () {
  ...
  function eyePieces() {
    ...
    for (const s of [-1, 1]) {
      ...
      out.push(
        ...
        { g: new THREE.CircleGeometry(0.050, R_TORSO), c: IRIS, x: x, y: y - 0.006, z: 0.2630 },
        { g: new THREE.CircleGeometry(0.026, R_NUB), c: P.ink, x: x, y: y - 0.006, z: 0.2650 },
        ...
        // one as a hole.
        { g: new THREE.CircleGeometry(0.014, R_NUB), c: CATCH, x: x - s * 0.019, y: y + 0.021, z: 0.2670 }
      );
    }
    return out;
  }
  ...
  function browPieces() {
    ...
    for (const s of [-1, 1]) {
      out.push({
        g: new THREE.CircleGeometry(0.030, R_TORSO), c: P.runnerHair,
        x: s * 0.100, y: 0, z: 0.2690, sx: 1.55, sy: 0.25, rz: s * 0.07,
      });
    }
    return out;
  }
  ...
  function create() {
    ...
    const headMesh = multi([
      ...
      { g: new THREE.SphereGeometry(0.268, R_HEAD, 12, 0, Math.PI * 2, 0, Math.PI * 0.3812), c: CAP, y: HY + 0.012 },
      ...
      { g: new THREE.SphereGeometry(0.070, R_NUB, 10), c: P.runnerHair,
        x: -0.195, y: HY + 0.045, z: 0.145, sx: 0.55, sy: 0.42, sz: 0.50, rz: 0.35 },
      { g: new THREE.SphereGeometry(0.070, R_NUB, 10), c: P.runnerHair,
        x: 0.195, y: HY + 0.045, z: 0.145, sx: 0.55, sy: 0.42, sz: 0.50, rz: -0.35 },
      { g: new THREE.SphereGeometry(0.050, R_NUB, 10), c: P.runnerHair,
        x: -0.228, y: HY - 0.075, z: 0.065, sx: 0.30, sy: 0.85, sz: 0.45 },
      { g: new THREE.SphereGeometry(0.050, R_NUB, 10), c: P.runnerHair,
        x: 0.228, y: HY - 0.075, z: 0.065, sx: 0.30, sy: 0.85, sz: 0.45 },
      ...
      // eight states.
      { g: new THREE.CylinderGeometry(0.272, 0.272, 0.070, R_HEAD), c: TRIM, y: HY + 0.118 },
    ...
    for (const side of [-1, 1]) {
      ...
      const fore = multi([
        ...
        ...(side === -1 ? [
          { g: new THREE.CylinderGeometry(0.032, 0.032, 0.018, 12), c: 0x1a2038,
            x: side * 0.090, y: -0.158, rz: Math.PI / 2 },
          { g: new THREE.CylinderGeometry(0.024, 0.024, 0.007, 12), c: 0xdff2ea,
            x: side * 0.099, y: -0.158, rz: Math.PI / 2 },
        ] : []),
      ]);
      elbow.add(fore);
