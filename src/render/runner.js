...
MR.Runner = (function () {
  ...
  function eyePieces() {
    ...
    for (const s of [-1, 1]) {
      ...
      out.push(
        ...
        { g: new THREE.CircleGeometry(0.061, R_TORSO), c: IRIS, x: x, y: y - 0.002, z: 0.2630 },
        { g: new THREE.CircleGeometry(0.031, R_NUB), c: P.ink, x: x, y: y - 0.002, z: 0.2650 },
  ...
  function mouthPieces() {
    return [
      { g: new THREE.CircleGeometry(0.050, R_TORSO), c: MOUTH, y: -0.023, z: 0.036, sx: 1.30, sy: 0.46 },
      { g: new THREE.CircleGeometry(0.050, R_TORSO), c: SKIN_SH, y: -0.040, z: 0.034, sx: 1.24, sy: 0.34 },
    ];
  }
  ...
  function create() {
    ...
    const headMesh = multi([
      ...
      { g: new THREE.CylinderGeometry(0.106, 0.124, 0.25, R_LIMB), c: P.runnerSkin, y: HY - 0.268 },
      ...
      // ---- THE EARS ---------------------------------------------------
      // Same argument, same verdict. Two squashed discs seated against the
      // skull's sides just under the cap line, slightly aft of centre the
      // way ears are. They add 0.014 of half-width at a height where the
      // figure's half-width is set by the SHOULDERS, so no lane or envelope
      // number can see them -- and from behind they read as the cap sitting
      // ON a head rather than being the head, which is its own small win.
      { g: new THREE.SphereGeometry(0.062, R_NUB, 10), c: P.runnerSkin,
        x: -0.252, y: HY - 0.042, z: -0.014, sx: 0.34, sy: 0.95, sz: 0.72 },
      { g: new THREE.SphereGeometry(0.062, R_NUB, 10), c: P.runnerSkin,
        x: 0.252, y: HY - 0.042, z: -0.014, sx: 0.34, sy: 0.95, sz: 0.72 },
      ...
      { g: new THREE.SphereGeometry(0.288, R_HEAD, 12, 0, Math.PI * 2, 0, Math.PI * 0.3812), c: CAP, y: HY },
      ...
      // eight states.
      { g: new THREE.CylinderGeometry(0.294, 0.294, 0.074, R_HEAD), c: TRIM, y: HY + 0.102 },
    ...
    const browPivot = pivot(head, 0, HY + 0.0490, 0);
    ...
    for (const side of [-1, 1]) {
      ...
      const upper = multi([
        { g: new THREE.CapsuleGeometry(0.070, 0.082, 6, R_LIMB), c: P.runnerSkin, y: -0.112 },
        ...
        { g: new THREE.SphereGeometry(0.092, R_LIMB, 14), c: P.runnerSkin, y: -0.052, sy: 0.86, sz: 0.92 },
        { g: new THREE.SphereGeometry(0.070, R_NUB, 12), c: P.runnerSkin, y: -0.100, z: -0.014, sx: 0.90, sy: 1.15 },
      ]);
      shoulder.add(upper);
      ...
      const fore = multi([
        { g: new THREE.CapsuleGeometry(0.062, 0.078, 6, R_LIMB), c: P.runnerSkin, y: -0.094 },
        ...
        { g: new THREE.SphereGeometry(0.078, R_NUB, 12), c: P.runnerSkin, y: -0.064, sx: 0.86, sy: 1.05 },
