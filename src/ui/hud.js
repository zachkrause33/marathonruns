...
MR.HUD = (function () {
  ...
  function create(root, opts) {
    ...
    root.innerHTML = `
      ...
      <div class="panel hidden" id="endPanel"><div class="panelInner">
        ...
        <!--
          ...
          everyone. rng.dateKey rolls at midnight Pacific for every player
          on earth, and pickSettings deals the city off that key, so two people
     ...
     */
    /**
     * REAL COASTLINES NOW (owner, 2026-09-22, with a reference world
     * map: "the map needs to be properly scaled... it needs to be
     * accurate"). Derived from Natural Earth 1:110m country boundaries:
     * countries grouped into the four tour regions, unioned, simplified
     * to 0.9 degrees with topology preserved, islands under six square
     * degrees dropped, clipped to 84N..56S -- 670 points in 37 parts,
     * about the budget of the old hand sketch, with the planet's actual
     * shapes. Greenland stays regionless furniture; Antarctica stays
     * off the paper. Europe and Asia meet at a drawn seam because each
     * region unions separately, which is exactly what the scratch-map
     * coloring needs. Equirectangular as before: mapPt is shared by
     * land, pins and trail, so they cannot disagree.
     */
    const LAND = [
      { reg: 'AFRICA', pts: [[-11.7, 6.9], [-17.6, 14.7], [-16, 23.7], [-9.6, 29.9], [-9.3, 32.6], [-5.9, 35.8], [-2.2, 35.2], [6.3, 37.1],
        [11, 37.1], [10.3, 33.8], [19.1, 30.3], [21.5, 32.8], [28.9, 30.9], [34.3, 31.2], [34.2, 27.8], [32.4, 29.9],
        [32.7, 28.7], [37.5, 18.6], [42.7, 11.7], [44.6, 10.4], [51.1, 12], [48.6, 5.3], [39.2, -4.7], [40.8, -14.7],
        [34.8, -19.8], [35.5, -24.1], [32.6, -25.7], [32.2, -28.8], [28.2, -32.8], [20.1, -34.8], [18.2, -33.9], [11.8, -18.1],
        [13.7, -10.7], [11.9, -5], [8.8, -1.1], [9.4, 3.7], [5.9, 4.3], [4.3, 6.3], [-8, 4.4]] },
      { reg: 'AFRICA', pts: [[49.9, -15.4], [47.1, -24.9], [44, -25], [43.3, -22.1], [44.4, -16.2], [47.7, -14.6], [49.2, -12]] },
      { reg: 'AMERICAS', pts: [[-96.6, 28.3], [-97.2, 20.6], [-94.4, 18.1], [-90.8, 19.3], [-90.3, 21], [-86.8, 21.3], [-88.9, 15.9], [-83.4, 15.3],
        [-83.8, 11.1], [-82.2, 9], [-79.6, 9.6], [-76.8, 8.6], [-71.8, 12.4], [-71.7, 9.1], [-69.9, 12.2], [-68.2, 10.6],
        [-61.9, 10.7], [-62.4, 9.9], [-57.1, 6], [-54, 5.8], [-54.5, 2.3], [-52.9, 2.1], [-51.3, 4.2], [-50, 1.7],
        [-50.7, 0.2], [-48.6, -1.2], [-40, -2.9], [-35.2, -5.5], [-35.1, -9], [-38.7, -13.1], [-40.9, -21.9], [-47.6, -24.9],
        [-48.9, -28.7], [-53.8, -34.4], [-58.4, -33.9], [-56.8, -36.9], [-59.2, -38.7], [-62.3, -38.8], [-62.7, -41], [-65.1, -41.1],
        [-63.5, -42.6], [-67.3, -45.6], [-66, -48.1], [-69.1, -50.7], [-68.2, -52.4], [-69.5, -52.3], [-70.8, -52.9], [-71, -53.8],
        [-74.9, -52.3], [-75.6, -48.7], [-74.1, -46.9], [-75.6, -46.6], [-72.7, -42.4], [-74.3, -43.2], [-71.4, -32.4], [-70.2, -19.8],
        [-71.5, -17.4], [-76, -14.6], [-81.3, -6.1], [-79.8, -2.7], [-80.9, -1.1], [-77.1, 3.8], [-78.2, 8.3], [-79.6, 8.9],
        [-80.9, 7.2], [-85.7, 9.9], [-87.5, 13.3], [-103.5, 18.3], [-105.5, 19.9], [-106, 22.8], [-114.8, 31.8], [-109.4, 23.2],
        [-112.2, 24.7], [-117.3, 33], [-120.6, 34.6], [-124.4, 40.3], [-124.7, 48.2], [-122.6, 47.1], [-122.8, 49], [-125.6, 50.4],
        [-127.4, 50.8], [-134.1, 58.1], [-147.1, 60.9], [-151.7, 59.2], [-150.6, 61.3], [-158.4, 56], [-164.8, 54.4], [-157, 58.9],
        [-162, 58.7], [-165.3, 60.5], [-165.7, 62.1], [-160.8, 63.8], [-160.8, 64.8], [-168.1, 65.7], [-161.7, 66.1], [-166.8, 68.4],
        [-156.6, 71.4], [-136.5, 68.9], [-128.1, 70.5], [-108.9, 67.4], [-108.2, 68.7], [-101.5, 67.6], [-97.7, 68.6], [-96.1, 67.3],
        [-94.2, 69.1], [-96.4, 71.2], [-93.9, 71.8], [-87.3, 67.2], [-85.5, 69.9], [-81.2, 68.7], [-81.4, 67.1], [-85.8, 66.6],
        [-94.2, 60.9], [-94.7, 58.9], [-92.3, 57.1], [-82.3, 55.1], [-79.9, 51.2], [-78.6, 52.6], [-79.8, 54.7], [-76.5, 56.5],
        [-78.5, 58.8], [-77.3, 59.9], [-78.1, 62.3], [-73.8, 62.4], [-69.6, 61.1], [-69.3, 59], [-67.7, 58.2], [-64.6, 60.3],
        [-61.8, 56.3], [-55.8, 53.3], [-55.7, 52.1], [-60, 50.2], [-66.4, 50.2], [-71.1, 46.8], [-65.1, 49.2], [-64.5, 46.2],
        [-63.2, 45.7], [-61.5, 45.9], [-60.5, 47], [-59.8, 45.9], [-65.4, 43.5], [-66.2, 44.5], [-64.4, 45.3], [-67.1, 45.1],
        [-70.6, 43.1], [-70, 41.6], [-75.5, 39.5], [-75.1, 38.4], [-75.9, 37.2], [-76.4, 39.1], [-75.7, 35.6], [-81.3, 31.4],
        [-80.4, 25.2], [-83.7, 29.9], [-88.4, 30.4], [-89.4, 29.2], [-93.8, 29.7]] },
      { reg: 'AMERICAS', pts: [[-77.8, 72.8], [-67, 69.2], [-68.8, 68.7], [-61.9, 66.9], [-63.9, 65], [-68, 66.3], [-64.7, 63.4], [-68.8, 63.7],
        [-66.2, 61.9], [-78.6, 64.6], [-74, 65.5], [-73.3, 68.1], [-79, 70.2], [-88.7, 70.4], [-90.2, 72.2], [-88.4, 73.5],
        [-85.8, 73.8], [-85.8, 72.5], [-82.3, 73.8], [-80.8, 72.1]] },
      { reg: 'AMERICAS', pts: [[-91.6, 81.9], [-72.8, 83.2], [-61.9, 82.6], [-76.9, 79.3], [-75.4, 78.5], [-80.6, 76.2], [-89.5, 76.5], [-88.3, 77.9],
        [-85, 77.5], [-88, 78.4], [-85.1, 79.3], [-86.9, 80.3], [-81.8, 80.5]] },
      { reg: 'AMERICAS', pts: [[-101, 70], [-113.3, 68.5], [-117.3, 70], [-112.4, 70.4], [-119.4, 71.6], [-115.2, 73.3], [-108.2, 71.7], [-107.5, 73.2]] },
      { reg: 'AMERICAS', pts: [[-113.7, 74.4], [-111.8, 75.2], [-117.7, 75.2], [-115.4, 76.5], [-109.1, 75.5], [-110.5, 76.4], [-109.6, 76.8], [-105.7, 75.5]] },
      { reg: 'AMERICAS', pts: [[-96.5, 72.6], [-98.4, 71.3], [-102.5, 72.5], [-100.4, 72.7], [-101.5, 73.4], [-100.4, 73.8]] },
      { reg: 'AMERICAS', pts: [[-115.5, 73.5], [-123.1, 70.9], [-125.9, 71.9], [-123.9, 73.7], [-124.9, 74.3]] },
      { reg: 'AMERICAS', pts: [[-96.7, 77.2], [-89.2, 75.6], [-81.1, 75.7], [-79.8, 74.9], [-92.4, 74.8]] },
      { reg: 'AMERICAS', pts: [[-54.5, 49.6], [-53.1, 46.7], [-59.4, 47.9], [-55.9, 51.6], [-56.8, 49.8]] },
      { reg: 'AMERICAS', pts: [[-65.1, -54.7], [-72.3, -54.5], [-74.7, -52.8], [-71.1, -54.1], [-68.6, -52.6]] },
      { reg: 'AMERICAS', pts: [[-82.3, 23.2], [-74.3, 20.1], [-77.8, 19.9], [-81.8, 22.6], [-85, 21.9]] },
      { reg: 'AMERICAS', pts: [[-92.4, 81.3], [-85.8, 79.3], [-92.9, 78.3], [-96.7, 80.2]] },
      { reg: 'AMERICAS', pts: [[-80.1, 63.7], [-85.5, 63.1], [-87.2, 63.5], [-85.9, 65.7]] },
      { reg: 'ASIA-PACIFIC', pts: [[56.3, 17.9], [43.5, 12.6], [42.3, 17.5], [34.6, 28.1], [34.3, 31.2], [36.2, 36.7], [29.7, 36.1], [26.3, 38.2],
        [26.2, 39.5], [29.2, 41.2], [41.7, 42], [36.7, 45.2], [40.1, 49.6], [31.8, 52.1], [31.3, 53.1], [32.7, 53.4],
        [30.9, 55.6], [27.3, 57.5], [29.1, 60], [28.1, 60.5], [31.5, 62.9], [29.6, 65], [37, 63.9], [36.9, 65],
        [180, 65], [177.4, 64.6], [179.2, 62.3], [170.3, 59.9], [163.5, 59.9], [162, 58.2], [163.2, 57.6], [162.1, 54.9],
        [156.8, 51], [155.9, 56.8], [164.5, 62.6], [160.1, 60.5], [159.3, 61.8], [156.7, 61.4], [154.2, 59.8], [155, 59.1],
        [142.2, 59], [135.1, 54.7], [139.9, 54.2], [141.4, 52.2], [138.2, 46.3], [127.5, 39.8], [129.1, 35.1], [126.5, 34.4],
        [126.9, 36.9], [124.7, 38.1], [125.3, 39.6], [121.1, 38.9], [121.6, 40.9], [118, 39.2], [118.9, 37.4], [122.4, 37.5],
        [119.2, 34.9], [121.9, 31.7], [121.7, 28.2], [115.9, 22.8], [110.4, 20.3], [108.5, 21.7], [105.9, 19.8], [109.3, 13.4],
        [109.2, 11.7], [105.2, 8.6], [100.1, 13.4], [99.2, 9.2], [103, 5.5], [104.2, 1.3], [101.4, 2.8], [98.3, 7.8],
        [97.2, 16.9], [94.2, 16], [94.3, 18.2], [91.4, 22.8], [87, 21.5], [80.3, 15.9], [79.9, 10.4], [77.5, 8],
        [73.5, 16], [72.6, 21.4], [70.5, 20.9], [66.4, 25.4], [53.5, 26.8], [48.9, 30.3], [48.4, 28.6], [50.8, 24.8],
        [51.6, 25.8], [51.8, 24], [54, 24.1], [56.4, 26.4], [56.8, 24.2], [59.8, 22.3]] },
      { reg: 'ASIA-PACIFIC', pts: [[53.2, 71.2], [51.5, 72], [55.6, 75.1], [61.2, 76.3], [68.9, 76.5], [58.5, 74.3], [55.6, 71.5], [67.1, 71.2],
        [69.9, 73], [72.6, 72.8], [72.2, 71.2], [74.7, 72.8], [76, 71.2], [81.5, 71.7], [80.5, 73.6], [104.4, 77.7],
        [114.1, 75.8], [109.4, 74.2], [127, 73.6], [129.9, 71.2], [139.9, 71.5], [139.1, 72.4], [140.5, 72.8], [152, 71.1],
        [178.9, 70.8], [159.2, 70.8], [160.9, 69.4], [168.2, 69.4], [73.8, 69.3], [74.4, 70.6], [72.6, 70.8], [72.6, 69.3],
        [68.1, 69.3], [66.7, 70.8], [-180, 70.8]] },
      { reg: 'ASIA-PACIFIC', pts: [[145.6, -16.8], [152.9, -25.3], [153.6, -28.1], [150, -37.4], [146.3, -39], [140.6, -38], [138.2, -34.4], [136.8, -35.3],
        [137.8, -32.9], [136, -34.9], [131.3, -31.5], [118, -35.1], [115, -34.2], [115.8, -32.2], [113.3, -26.1], [114.2, -26.3],
        [113.7, -22.5], [120.9, -19.7], [122.7, -16.8], [-180, -16.6], [124.3, -16.1], [127.1, -13.8], [129.6, -15], [132.4, -11.1],
        [137, -12.4], [135.4, -14.7], [136.3, -15.6], [141.3, -16.1], [142.5, -10.7], [145.4, -16.1], [180, -16.1]] },
      { reg: 'ASIA-PACIFIC', pts: [[147.9, -6.6], [147.2, -7.4], [150.7, -10.6], [144.7, -7.6], [142.6, -9.3], [137.6, -8.4], [138.7, -7.3], [137.9, -5.4],
        [133, -4.1], [132, -2.8], [133.7, -2.2], [130.5, -0.9], [134, -0.8], [135.5, -3.4], [138.3, -1.7], [144.6, -3.9]] },
      { reg: 'ASIA-PACIFIC', pts: [[120.2, 0.2], [120.9, -1.4], [123.3, -0.6], [121.5, -1.9], [123.2, -4.7], [122.6, -5.6], [121, -2.6], [120.4, -5.5],
        [119.4, -5.4], [119.8, 0.2], [125.2, 1.4]] },
      { reg: 'ASIA-PACIFIC', pts: [[140.8, 35.8], [135.8, 33.5], [135.1, 34.6], [131, 33.9], [132, 33.1], [130.7, 31], [129.4, 33.3], [132.6, 35.4],
        [135.7, 35.5], [141.4, 41.4]] },
      { reg: 'ASIA-PACIFIC', pts: [[116.6, -1.5], [116.1, -4], [112.1, -3.5], [110.2, -2.9], [109, 0.4], [117.1, 6.9], [119.2, 5.4], [117.3, 3.2],
        [119, 0.9]] },
      { reg: 'ASIA-PACIFIC', pts: [[105.8, -5.9], [101.4, -2.8], [95.3, 5.5], [97.5, 5.2], [103.8, 0.1], [106.1, -3.1]] },
      { reg: 'ASIA-PACIFIC', pts: [[175.2, -41.7], [173.8, -39.5], [174.7, -37.4], [172.6, -34.5], [176, -37.6], [178.5, -37.7]] },
      { reg: 'ASIA-PACIFIC', pts: [[143.5, 46.1], [141.9, 46.8], [142.7, 54.4], [144.7, 49], [143.2, 49.3], [142.6, 47.9]] },
      { reg: 'ASIA-PACIFIC', pts: [[172.1, -41], [174.2, -41.8], [173.1, -43.9], [170.6, -45.9], [166.7, -46.2]] },
      { reg: 'ASIA-PACIFIC', pts: [[140, 41.6], [142, 45.6], [145.3, 44.4], [145.5, 43.3], [143.2, 42]] },
      { reg: 'ASIA-PACIFIC', pts: [[115.7, -8.4], [108.3, -7.8], [105.4, -6.9], [106.1, -5.9], [110.8, -6.5]] },
      { reg: 'ASIA-PACIFIC', pts: [[121.5, 15.1], [124.1, 12.5], [120.6, 13.9], [120.7, 18.5], [122.2, 18.5]] },
      { reg: 'ASIA-PACIFIC', pts: [[125.4, 5.6], [123.6, 7.8], [121.9, 7.2], [125.4, 9.8], [126.5, 7.2]] },
      { reg: 'ASIA-PACIFIC', pts: [[146, -43.5], [144.7, -40.7], [148.3, -40.9], [147.9, -43.2]] },
      { reg: 'EUROPE', pts: [[-8.9, 36.9], [-9.4, 43], [-1.4, 44], [-1.2, 46], [-4.6, 48.7], [-1.6, 48.6], [-1.9, 49.8], [8.1, 53.5],
        [8.1, 56.5], [10.6, 57.7], [9.6, 55.5], [10.9, 54], [22.7, 54.3], [21.1, 56.8], [24.1, 57], [23.3, 59.2],
        [28, 59.5], [27.3, 57.5], [30.9, 55.6], [32.7, 53.4], [31.3, 53.1], [31.8, 52.1], [40.1, 49.6], [39.7, 47.9],
        [35, 45.7], [30.7, 46.6], [28, 42], [22.8, 40.5], [24, 38.2], [23.2, 36.4], [21.7, 36.8], [19.5, 41.7],
        [13.1, 45.7], [12.6, 44.1], [18.5, 40.2], [16.9, 40.4], [16.1, 38], [15.4, 40], [8.9, 44.4], [3.1, 43.1],
        [-2.1, 36.7]] },
      { reg: 'EUROPE', pts: [[22.2, 65.7], [17.8, 62.7], [17.1, 61.3], [18.8, 60.1], [14.1, 55.4], [10.4, 59.5], [5.7, 58.6], [5, 62],
        [14.8, 67.8], [24.5, 71], [31.3, 70.5], [28.4, 68.4], [30, 67.7], [29.5, 64.9], [31.5, 62.9], [30.2, 61.8],
        [22.9, 59.8], [21.1, 62.6], [25.3, 65.5]] },
      { reg: 'EUROPE', pts: [[-5.1, 55.1], [-5.8, 57.8], [-3, 58.6], [-4.1, 57.6], [-2, 57.7], [-3.1, 56], [1.7, 52.7], [1.4, 51.3],
        [-5.8, 50.2], [-3.4, 51.4], [-5.3, 52], [-2.9, 54]] },
      { reg: 'EUROPE', pts: [[-22.8, 64], [-21.8, 64.4], [-24, 64.9], [-22.2, 65.1], [-24.3, 65.6], [-23.7, 66.3], [-14.5, 66.5], [-13.6, 65.1],
        [-18.7, 63.5]] },
      { reg: 'EUROPE', pts: [[-8.3, 54.7], [-5.7, 54.6], [-6, 53.2], [-10, 51.8]] },
      { reg: null, pts: [[-46.8, 82.6], [-27.1, 83.5], [-20.8, 82.7], [-31.9, 82.2], [-12.2, 81.3], [-20, 80.2], [-17.7, 80.1], [-19.7, 78.8],
        [-18.5, 77], [-21.7, 76.6], [-19.8, 76.1], [-20.7, 75.2], [-19.4, 74.3], [-23.6, 73.3], [-22.3, 72.2], [-24.8, 72.3],
        [-21.8, 70.7], [-25.5, 71.4], [-26.4, 70.2], [-22.3, 70.1], [-39.8, 65.5], [-42.8, 62.7], [-43.4, 60.1], [-48.3, 60.9],
        [-51.6, 63.6], [-54, 67.2], [-50.9, 69.9], [-54.7, 69.6], [-54.4, 70.8], [-51.4, 70.6], [-55.8, 71.7], [-54.7, 72.6],
        [-58.6, 75.5], [-68.5, 76.1], [-71.4, 77], [-66.8, 77.4], [-73.3, 78], [-65.7, 79.4], [-68, 80.1], [-62.6, 81.8],
        [-44.5, 81.7]] },
    ];
    // Content coordinates: x 0..360, y 20..135 (the poles are not on the
    // paper). The paper adds a PAD frame around the ocean.
    // The band widened with the real data: 84N..56S, so Patagonia and
    // the arctic coasts are on the paper instead of cut at the fold.
    const MAP_PAD = 6, MAP_Y0 = 6, MAP_H = 140;
    ...
    function drawMap(sum, pool, loadedTag, animate) {
      ...
      const pinsFor = function (list, labelSel, ps) {
        ...
        return order.map(function (s, i) {
          const c = seen[s.name];
          // Two colors on the paper (owner, 2026-09-22): a city is DONE or
          // it is not. Which medal it is done AT belongs to the popup and
          // the wall -- four metals on 25 small pins read as confetti.
          const done = !!c;
          ...
          return '<g class="pinP' + (isSel ? ' sel' : '') + '" transform="translate(' + xy[0] + ',' + xy[1] + ')'
            ...
            + '<path class="pin ' + (done ? 'done' : 'new') + '" d="M0 0C-4.2-6.2-6.5-8.4-6.5-12A6.5 6.5 0 1 1 6.5-12C6.5-8.4 4.2-6.2 0 0Z"/>'
            + '<circle class="pinHole" cx="0" cy="-12" r="2.5"/>'
            + '</g>'
            + (isSel && labelSel ? '<text class="pinLab" y="-22">' + s.name + '</text>' : '')
            + '<circle class="pinHit" r="13" cy="-9" data-pin="' + s.tag + '"><title>' + s.name + '</title></circle>'
            + '</g>'
            + '</g>';
        }).join('');
      };
      const pins = pinsFor(pool, true, 0.72);
    ...
    api.setLocked = function (info) {
      ...
      const tick = function () {
        let s = '';
        try {
          if (MR.rng.dateKey() !== info.dateKey) s = 'A NEW ROAD IS READY · RELOAD';
          else {
            const mins = Math.ceil(MR.rng.nextResetMs() / 60000);
            const h = Math.floor(mins / 60), m = mins - h * 60;
            s = 'NEXT COURSE IN ' + (h > 0 ? h + 'H ' : '') + m + 'M';
          }
        } catch (e) { /* the countdown is a courtesy, never a crash */ }
